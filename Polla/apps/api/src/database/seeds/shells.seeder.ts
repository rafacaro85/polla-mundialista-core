...
async function seed() {
    try {
        ...
        const phases = [
            { name: 'ROUND_32', count: 16, startNum: 1, baseDate: '2026-06-28T12:00:00Z' },
            { name: 'ROUND_16', count: 8, startNum: 17, baseDate: '2026-07-04T12:00:00Z' },
            { name: 'QUARTER', count: 4, startNum: 25, baseDate: '2026-07-09T12:00:00Z' },
            { name: 'SEMI', count: 2, startNum: 29, baseDate: '2026-07-14T12:00:00Z' },
            { name: '3RD_PLACE', count: 1, startNum: 31, baseDate: '2026-07-18T12:00:00Z' },
            { name: 'FINAL', count: 1, startNum: 32, baseDate: '2026-07-19T12:00:00Z' },
        ];
        ...
        for (const phase of phases) {
            ...
            for (let i = 0; i < phase.count; i++) {
                ...
                if (exists) {
                    console.log(`   🔸 Match ${phase.name} #${matchIndex} (ID: ${matchId}) ya existe. Saltando.`);
                    skippedCount++;
                    continue;
                }
