...
const matchesData = [
  ...
  // --- OCTAVOS ---
  {
    ...
    stadium: 'Estadio Filadelfia',
    bracket_id: 89,
    home_placeholder: 'Ganador 73',
    away_placeholder: 'Ganador 74',
  },
  {
    phase: 'ROUND_16',
    ...
    stadium: 'Estadio Houston',
    bracket_id: 90,
    home_placeholder: 'Ganador 75',
    away_placeholder: 'Ganador 76',
  },
  {
    phase: 'ROUND_16',
    ...
    stadium: 'Estadio NY/NJ',
    bracket_id: 91,
    home_placeholder: 'Ganador 77',
    away_placeholder: 'Ganador 78',
  },
  {
    phase: 'ROUND_16',
    ...
    stadium: 'Estadio Cd México',
    bracket_id: 92,
    home_placeholder: 'Ganador 79',
    away_placeholder: 'Ganador 80',
  },
  {
    phase: 'ROUND_16',
    ...
    stadium: 'Estadio Dallas',
    bracket_id: 93,
    home_placeholder: 'Ganador 81',
    away_placeholder: 'Ganador 82',
  },
  {
    phase: 'ROUND_16',
    ...
    stadium: 'Estadio Seattle',
    bracket_id: 94,
    home_placeholder: 'Ganador 83',
    away_placeholder: 'Ganador 84',
  },
  {
    phase: 'ROUND_16',
    ...
    stadium: 'Estadio Atlanta',
    bracket_id: 95,
    home_placeholder: 'Ganador 85',
    away_placeholder: 'Ganador 86',
  },
  {
    phase: 'ROUND_16',
    ...
    stadium: 'Estadio Vancouver',
    bracket_id: 96,
    home_placeholder: 'Ganador 87',
    away_placeholder: 'Ganador 88',
  },
  ...
  // --- CUARTOS ---
  {
    ...
    stadium: 'Estadio Boston',
    bracket_id: 97,
    home_placeholder: 'Ganador 89',
    away_placeholder: 'Ganador 90',
  },
  {
    phase: 'QUARTER',
    ...
    stadium: 'Estadio Los Ángeles',
    bracket_id: 98,
    home_placeholder: 'Ganador 91',
    away_placeholder: 'Ganador 92',
  },
  {
    phase: 'QUARTER',
    ...
    stadium: 'Estadio Miami',
    bracket_id: 99,
    home_placeholder: 'Ganador 93',
    away_placeholder: 'Ganador 94',
  },
  {
    phase: 'QUARTER',
    ...
    stadium: 'Estadio Kansas City',
    bracket_id: 100,
    home_placeholder: 'Ganador 95',
    away_placeholder: 'Ganador 96',
  },
  ...
  // --- SEMIS ---
  {
    ...
    stadium: 'Estadio Dallas',
    bracket_id: 101,
    home_placeholder: 'Ganador 97',
    away_placeholder: 'Ganador 98',
  },
  {
    phase: 'SEMI',
    ...
    stadium: 'Estadio Atlanta',
    bracket_id: 102,
    home_placeholder: 'Ganador 99',
    away_placeholder: 'Ganador 100',
  },
  ...
  // --- TERCER PUESTO ---
  {
    ...
    stadium: 'Estadio Miami',
    bracket_id: 103,
    home_placeholder: 'Perdedor 101',
    away_placeholder: 'Perdedor 102',
  },
  ...
  // --- FINAL ---
  {
    ...
    stadium: 'Estadio NY/NJ',
    bracket_id: 104,
    home_placeholder: 'Ganador 101',
    away_placeholder: 'Ganador 102',
  },
];
...
async function main() {
  ...
  try {
    ...
    console.log(
      '✅ ¡Calendario Oficial FIFA 2026 (104 partidos) sincronizado con éxito!',
    );
  } catch (err) {
