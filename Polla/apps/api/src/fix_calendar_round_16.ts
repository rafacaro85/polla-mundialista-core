...
async function fixRound16Calendar() {
  ...
  try {
    ...
    if (matches.length !== 8) {
      console.warn(
        `WARNING: Expected 8 matches for ROUND_16, found ${matches.length}. Proceeding anyway.`,
      );
    }
    ...
    const targetDates = [
      ...
      '2026-07-04T16:00:00Z', // Day 1
      '2026-07-05T12:00:00Z',
      '2026-07-05T16:00:00Z', // Day 2
      '2026-07-06T12:00:00Z',
      '2026-07-06T16:00:00Z', // Day 3
      '2026-07-07T12:00:00Z',
      '2026-07-07T16:00:00Z', // Day 4
    ];
    ...
    for (let i = 0; i < matches.length; i++) {
      ...
      console.log(
        `Updated Match ${match.id} (${match.homeTeamPlaceholder || 'H'} vs ${match.awayTeamPlaceholder || 'A'}) to ${newDate}`,
      );
    }
