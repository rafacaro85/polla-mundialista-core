...
const WC_COUNTRIES: Record<string, string> = {
    'co': 'co', 'ar': 'ar', 'br': 'br', 'fr': 'fr', 'es': 'es', 'de': 'de',
    'us': 'us', 'mx': 'mx', 'gb-eng': 'gb-eng', 'it': 'it', 'pt': 'pt',
    'uy': 'uy', 'cl': 'cl', 'ec': 'ec', 'pe': 'pe', 'py': 'py', 've': 've',
    'bo': 'bo', 'ca': 'ca', 'cr': 'cr', 'jm': 'jm', 'pa': 'pa', 'ht': 'ht',
    'au': 'au', 'qa': 'qa', 'za': 'za', 'kr': 'kr', 'jp': 'jp', 'ma': 'ma',
    'sn': 'sn', 'nl': 'nl', 'ir': 'ir', 'gb-wls': 'gb-wls', 'be': 'be',
    'hr': 'hr', 'eg': 'eg', 'rs': 'rs', 'gb-sct': 'gb-sct', 'sa': 'sa',
    'pl': 'pl', 'tn': 'tn', 'at': 'at', 'nz': 'nz', 'ci': 'ci', 'no': 'no',
    'dz': 'dz', 'uz': 'uz', 'gh': 'gh', 'cv': 'cv', 'cw': 'cw', 'ch': 'ch',
    'gr': 'gr', 'fi': 'fi', 'se': 'se', 'hn': 'hn', 'dk': 'dk', 'cm': 'cm'
};
...
const FLAGS_DIR = path.join(__dirname, '../../../../apps/web/public/assets/flags');
