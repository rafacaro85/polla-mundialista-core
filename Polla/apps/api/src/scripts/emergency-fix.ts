...
async function run() {
  ...
  try {
    ...
    if (res.rows.length > 0) {
      ...
      await client.query('ALTER TABLE leagues ADD COLUMN brand_color_heading VARCHAR(255) DEFAULT \'#FFFFFF\'');
      await client.query('ALTER TABLE leagues ADD COLUMN brand_color_bars VARCHAR(255) DEFAULT \'#00E676\'');
