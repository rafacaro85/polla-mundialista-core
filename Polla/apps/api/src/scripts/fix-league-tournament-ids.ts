...
async function run() {
    ...
    console.log(`✅ Updated ${result[1]} leagues to have tournament_id = 'WC2026'`);

    // Verify
    const leagues = await queryRunner.query(`SELECT id, name, tournament_id FROM leagues LIMIT 10`);
    console.log('\n📊 Updated Leagues:');
