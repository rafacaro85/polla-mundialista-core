...
async function seedUCL() {
    ...
    try {
        ...
        const FLAGS: Record<string, string> = {
            ...
            'Liverpool': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/0/0c/Liverpool_FC.svg&w=200&output=png',
            'PSV': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/0/05/PSV_Eindhoven.svg&w=200&output=png',
            'Arsenal': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/5/53/Arsenal_FC.svg&w=200&output=png',
            'Club Brugge': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/d/d0/Club_Brugge_KV_logo.svg&w=200&output=png',
            'Atletico Madrid': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/f/f4/Atletico_Madrid_2017_logo.svg&w=200&output=png',
            'Juventus': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/b/bc/Juventus_FC_2017_icon_%28black%29.svg&w=200&output=png',
            'Manchester City': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/e/eb/Manchester_City_FC_badge.svg&w=200&output=png',
            'Bayer Leverkusen': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/5/59/Bayer_04_Leverkusen_logo.svg&w=200&output=png',
            'Inter Milan': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/0/05/FC_Internazionale_Milano_2021.svg&w=200&output=png',
            'Sporting CP': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/e/e1/Sporting_Clube_de_Portugal_%28Logo%29.svg&w=200&output=png',
            'Bayern Munich': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/1/1b/FC_Bayern_M%C3%BCnchen_logo_%282017%29.svg&w=200&output=png',
            'Feyenoord': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/e/e3/Feyenoord_logo.svg&w=200&output=png',
            'PSG': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/a/a7/Paris_Saint-Germain_F.C..svg&w=200&output=png',
            'Galatasaray': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/f/f6/Galatasaray_Sports_Club_Logo.png&w=200&output=png',
            'Monaco': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/4/4e/AS_Monaco_FC_logo.svg&w=200&output=png', 
            'Borussia Dortmund': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/commons/6/67/Borussia_Dortmund_logo.svg&w=200&output=png',
            'Atalanta': 'https://images.weserv.nl/?url=upload.wikimedia.org/wikipedia/en/6/66/AtalantaBC.svg&w=200&output=png',
