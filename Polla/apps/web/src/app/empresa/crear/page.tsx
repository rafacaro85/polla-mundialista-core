        ...
        <React.Suspense fallback={
            <div className="min-h-screen bg-[#0F172A] flex items-center justify-center p-4">
                <div className="flex flex-col items-center gap-4">
                    <div className="w-12 h-12 border-4 border-[#00E676]/20 border-t-[#00E676] rounded-full animate-spin" />
                    <p className="text-[#94A3B8] font-russo text-xs uppercase tracking-widest">Cargando Studio...</p>
                </div>
            </div>
        }>
