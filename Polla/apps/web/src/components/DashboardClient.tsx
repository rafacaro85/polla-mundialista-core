...
return (
  ...
  >
    ...
    <main className="mx-auto w-full max-w-7xl flex-1 p-4 overflow-hidden">
      ...
      <div className="w-full">
        {activeTab === 'game' && (
          <div className="mt-4 animate-in fade-in slide-in-from-left-4 duration-300">
            ...
            <div className="flex flex-col gap-4 pb-4">
              {loadingMatches ? (
                <p className="col-span-full text-center text-slate-400 py-8 animate-pulse">Cargando partidos...</p>
                ...
                <p className="col-span-full text-center text-slate-400 py-8">No hay partidos para esta fecha.</p>
              )}
            </div>
          </div>
        )}
        ...
        {activeTab === 'bracket' && (
          <div className="h-full flex flex-col animate-in fade-in zoom-in-95 duration-300">
            <div className="mb-4">
              <h3 className="text-xl font-bold font-russo text-[#00E676] mb-2">Simulador del Torneo</h3>
              <p className="text-slate-400 text-sm mb-4">Visualiza el camino a la copa.</p>
