    ...
    <div style={STYLES.wrapper} ref={menuRef}>
      ...
      {isOpen && (
        <div style={STYLES.dropdown}>
          ...
          <MenuItem icon={User} label="Mi Perfil" onClick={handleProfile} hasArrow />

          {/* ACCIONES DE CONTEXTO DE LIGA */}
          ...
          <MenuItem icon={LayoutGrid} label="Ir al Dashboard" onClick={() => router.push('/dashboard')} hasArrow />

          {/* ACCIONES GLOBALES ADMIN */}
          {/* ... */}

          <div style={STYLES.divider} />

          <MenuItem icon={LogOut} label="Cerrar Sesión" onClick={logout} isDanger />
        </div>
      )}
    </div>
  );
...
const STYLES = {
  ...
  avatarTrigger: {
    width: '36px', // Tamaño reducido (antes era 48px o más)
    height: '36px',
    borderRadius: '50%',
